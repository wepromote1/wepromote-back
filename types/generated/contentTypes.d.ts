...
export interface ApiHiringPageHiringPage extends Schema.SingleType {
  collectionName: 'hiring_pages';
  info: {
    singularName: 'hiring-page';
    pluralName: 'hiring-pages';
    displayName: 'HiringPage';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiHomepageHomepage extends Schema.SingleType {
  ...
  attributes: {
    smallText1: Attribute.String;
    smallText2: Attribute.String;
    smallText3: Attribute.String;
    smallText4: Attribute.String;
    smallText5: Attribute.String;
    smallText6: Attribute.String;
    heroText: Attribute.String;
    scrollImages: Attribute.Media<'images', true>;
    servicesTagline: Attribute.String;
    servicesBigText: Attribute.String;
    workDone: Attribute.String;
    workText: Attribute.String;
    logosText: Attribute.String;
    workBigImage: Attribute.Media<'images' | 'files' | 'videos' | 'audios'>;
    workSmallImage: Attribute.Media<'images' | 'files' | 'videos' | 'audios'>;
    teamImage: Attribute.Media<'images' | 'files' | 'videos' | 'audios'>;
    homeLogos: Attribute.Media<'images', true>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
export interface ApiJobOpeningJobOpening extends Schema.CollectionType {
  ...
  attributes: {
    ...
    >;
    jobStatus: Attribute.Enumeration<['Full-Time', 'Part-Time']>;
    slug: Attribute.UID<'api::job-opening.job-opening', 'jobTitle'>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
export interface ApiProjectProject extends Schema.CollectionType {
  ...
  attributes: {
    ...
    projectImages: Attribute.Media<'images', true>;
    firstSectionTitle: Attribute.String;
    firstSectionContent: Attribute.Blocks;
    secondSectionTitle: Attribute.String;
    secondSectionContent: Attribute.Blocks;
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::hiring-page.hiring-page': ApiHiringPageHiringPage;
